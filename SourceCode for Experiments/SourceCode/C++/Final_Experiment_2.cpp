...
int main() {
    ...
    double average, Sample_Points[3000];
...
/////////////////////////////////////// the for loop below gives random LWE instances, and for each instance we will try to find collisions.
        ...
        for (iteration = 0; iteration < 1000000000; iteration++) { //
            ...
            if (flavour(x) % 2 == flavour(y) % 2) {
                ...
                if (flag == 1) {
                    ...
                    Sample_Points[number_collision_per_lwe] = found;
                    found = 0;

                    number_collision_per_lwe++;
                    if (number_collision_per_lwe == 3000)
                        break;


                    cout << endl;
                    cout << endl;
                    cout << "# Data points: " << number_collision_per_lwe << endl;

                    for (int i1 = 0; i1 < number_collision_per_lwe; i1++)
                        cout << Sample_Points[i1] << ", ";
                    cout << endl;
                    cout << endl;
    ...
    cout << "Final average: " << (double) average / 3000 << endl;
