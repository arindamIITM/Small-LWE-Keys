...
int main() {
    ...
    double average, Sample_Points[1000];
...
/////////////////////////////////////// the for loop below gives random LWE instances, and for each instance we will try to find collisions.
    for (int num_exp = 0; num_exp < 1000; num_exp++) {
        ...
        for (iteration = 0; iteration < 1000000000; iteration++) { //
            ...
            if (flavour(x) % 2 == flavour(y) % 2) {
                ...
                if (flag == 1) {
                    ...
                    number_collision_per_lwe++;
                    if (number_collision_per_lwe == 30)
                        break;
        ...
        if (number_collision_per_lwe == 30) {
            ...
            average = (double) collision / number_collision_per_lwe;
            Sample_Points[num_exp] = average;


            cout << "#Number of LWE instances: " << num_exp + 1 << "\t     Average: " << average << "\t      n= " << n
                 << endl;    // Count:  //" << count"

        } else
            cout << "#Number of LWE instances: Fail" << "    Count: " << count << endl;
    ...
    cout << "Final average: " << (double) average / 1000 << endl;
